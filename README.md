...
- [x] Phase 3B (partial): Changesets + Version PR (`.changeset/`, `changeset-version.yml`); gated `release-plugin.yml` (manual; no auto-publish). Operator still: Environment `release-npm` + npm Trusted Publisher + first `1.0.0`
